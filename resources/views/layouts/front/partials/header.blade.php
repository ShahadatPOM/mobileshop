            ...
            <div class="col-12">
                ...
                <div class="offcanvas_menu_wrapper">
                    ...
                    <div class="language_currency top">
                        <ul>
                            <li class="language"><a href="#"><img src="{{asset('assets/front/img/icon/language.png')}}" alt=""> English <i class="icon-right ion-ios-arrow-down"></i></a>
                        ...
                        <div class="header_account_list  mini_cart_wrapper">
                            ...
                            <div class="mini_cart">
                                <div class="cart_gallery">
                                    <div class="cart_item">
                                       <div class="cart_img">
                                           <a href="#"><img src="{{asset('assets/front/img/s-product/product.jpg')}}" alt=""></a>
                                       </div>
                                        <div class="cart_info">
                                    ...
                                    <div class="cart_item">
                                       <div class="cart_img">
                                           <a href="#"><img src="{{asset('assets/front/img/s-product/product2.jpg')}}" alt=""></a>
                                       </div>
                                        <div class="cart_info">
                                        ...
                                        <li class="mega_items"><a href="shop.html">shop<i class="fa fa-angle-down"></i></a> 
                                            <div class="mega_menu">
                                                <ul class="mega_menu_inner">
                                                    ...
                                                    <li><a href="#"><img src="{{asset('assets/front/img/bg/banner_menu.jpg')}}" alt=""></a></li>
                                                </ul>
                                            </div>
                                        </li>
